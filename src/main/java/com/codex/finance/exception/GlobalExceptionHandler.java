...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, Object>> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
		...
		return ResponseEntity.badRequest()
				.body(errorBody("invalid_parameter", "El valor de '" + paramName + "' no es válido."));
	}
	...
	public ResponseEntity<Map<String, Object>> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
		...
		Map<String, Object> response = Map.of("error", "data_integrity", "message",
				message != null && message.contains("enum") ? "Uno de los valores seleccionados no es válido."
	...
	public ResponseEntity<Map<String, Object>> handleOther(Exception ex) {
		...
		return ResponseEntity.internalServerError()
				.body(errorBody("internal_error", "Ocurrió un error inesperado. Intenta nuevamente."));
	}
